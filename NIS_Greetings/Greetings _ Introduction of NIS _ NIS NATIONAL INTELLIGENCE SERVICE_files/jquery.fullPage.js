    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        function keyUpHandler(e){
            ...
            var keyCode = e.which;
            if(keyCode === 9){
                if (activeElement.closest('.fp-section').length) {
                    onTab(e);
                }
            }
        }
        ...
        */
        function onTab(e){
            ...
            if(!isShiftPressed && activeElement.is(focusableElements.last()) && activeElement.closest(SECTION_SEL, SLIDE_SEL).next(SECTION_SEL, SLIDE_SEL).length ){
                moveSectionDown();
            } else if(isShiftPressed && activeElement.is(focusableElements.first()) && activeElement.closest(SECTION_SEL, SLIDE_SEL).prev(SECTION_SEL, SLIDE_SEL).length ){
                moveSectionUp();
            } 
        }
